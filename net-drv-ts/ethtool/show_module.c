...
/**
 * @defgroup ethtool-show_module Show transceiver module parameters with ethtool
 * @ingroup ethtool
 * @{
 *
 * @objective Check that ethtool can show transceiver module parameters for
 *            a tested interface.
 *
...
#define TE_TEST_NAME "ethtool/show_module"
...
main(int argc, char *argv[])
{
    ...
    TEST_STEP("Run 'ethtool \\--show-module @p iut_if'. Check that it "
              "terminates successfully, does not print anything to "
              "stderr and its output can be parsed.");

    opts.cmd = TAPI_ETHTOOL_CMD_SHOW_MODULE;
