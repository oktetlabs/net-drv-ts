...
# Contributing code to Network Interface Driver Test Suite

The document provides the guidelines for submitting changes to NetDrv TS.
...
The summary line should:
 ...
 - start with the imperative of a verb, for example:
   ...
   ```
   rss: implement TAPI for RSS tests
   ```

   ```
   offload/receive_offload: check hardware GRO
   ```
